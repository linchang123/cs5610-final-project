...
// 🛠️ Decide link based on role
const finalQuizURL = currentUser.role === "STUDENT" 
 ? `#/Kambaz/Courses/${quiz.courseId}/Quizzes/${quiz._id}/Take`
 : quizURL;
             ...
             <Row>
                 <Col>
                     <span onClick={handlePublishSymbolClick}>
                         {published ? <GreenCheckMark /> : <AiOutlineStop className="fs-2" />}
                     </span>
                 </Col>
                 <Col>
                     <Dropdown className="float-end me-2">
                         ...
                         <Dropdown.Menu>
                             <Dropdown.Item onClick={handleEditButtonClick} id="wd-quiz-menu-edit-option">
                                 Edit
                             </Dropdown.Item>
                             <Dropdown.Item onClick={handleDeleteButtonClick} id="wd-quiz-menu-delete-option">
                                 Delete
                             </Dropdown.Item>
                             <Dropdown.Item onClick={handlePublishSymbolClick} id="wd-quiz-menu-publish-option">
